      ...
      <div className="border-b border-white/8 pb-12">
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="text-xs text-[#9090B8]">ScamLens AI</div>
              <h1 className="text-2xl font-black tracking-tight">{titles[lang]}</h1>
            </div>
          </div>
          <p className="text-[#9090B8] text-sm mb-6">{dates[lang]} &nbsp;·&nbsp; Vibe A</p>
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all ${
                  lang === l.id
                    ...
                    : "bg-white/6 text-[#9090B8] hover:bg-white/10"
                }`}
              >
                {l.label}
              </button>
  ...
  return (
    <>
      <div className="bg-[rgba(91,110,245,0.06)] border border-[rgba(91,110,245,0.2)] rounded-xl p-5 mb-10 text-sm text-[#9090B8] leading-relaxed">
        ...
        본 약관은 <strong className="text-white">약관의 규제에 관한 법률</strong>, <strong className="text-white">정보통신망 이용촉진 및 정보보호 등에 관한 법률</strong>,
        <strong className="text-white"> 전자상거래 등에서의 소비자보호에 관한 법률</strong>에 따라 작성되었습니다.
      </div>
      ...
      <Section title="제2조 (정의)">
        <ul>
          <li><strong className="text-white">&ldquo;서비스&rdquo;</strong>란 회사가 제공하는 ScamLens AI 모바일 애플리케이션 및 관련 기능 일체를 의미합니다.</li>
          <li><strong className="text-white">&ldquo;이용자&rdquo;</strong>란 본 약관에 동의하고 서비스를 이용하는 자를 말합니다.</li>
          <li><strong className="text-white">&ldquo;유료 서비스&rdquo;</strong>란 구독 결제를 통해 제공되는 Gemini AI 심층 분석 등 프리미엄 기능을 말합니다.</li>
          <li><strong className="text-white">&ldquo;온디바이스 AI&rdquo;</strong>란 이용자의 기기에서 직접 실행되는 인공지능 분석 기능을 말합니다.</li>
        </ul>
      </Section>
      ...
      <Section title="제3조 (약관의 효력 및 변경)">
        <ul>
          ...
          <li>회사는 합리적 사유가 있을 경우 약관을 변경할 수 있으며, 변경 약관은 적용일 <strong className="text-white">7일 전</strong>부터 공지합니다. 다만, 이용자에게 불리한 변경은 <strong className="text-white">30일 전</strong>에 공지합니다.</li>
      ...
      <Section title="제4조 (서비스의 제공)">
        <ul>
          <li><strong className="text-white">무료 서비스:</strong> 온디바이스 AI 기반 스미싱·피싱 탐지, 위험도 알림, 기본 통계, 앱 안전성 검사</li>
          <li><strong className="text-white">유료 서비스 (월 구독):</strong> Gemini AI 심층 분석, 상세 탐지 보고서, URL 안전성 검사</li>
        </ul>
      ...
      <Section title="제9조 (서비스 중단 및 종료)">
        <ul>
          <li>회사는 운영이 불가능한 경우 <strong className="text-white">30일 전</strong> 공지 후 서비스를 종료할 수 있습니다.</li>
      ...
      <Section title="제10조 (준거법 및 분쟁 해결)">
        <ul>
          <li>본 약관은 <strong className="text-white">대한민국 법률</strong>에 따라 해석됩니다.</li>
          <li>분쟁 발생 시 회사와 이용자는 상호 협의로 우선 해결을 시도합니다.</li>
          <li>협의 불성립 시 민사소송법에 따른 관할 법원(<strong className="text-white">서울중앙지방법원</strong>)을 제1심 법원으로 합니다.</li>
  ...
  return (
    <>
      <div className="bg-[rgba(91,110,245,0.06)] border border-[rgba(91,110,245,0.2)] rounded-xl p-5 mb-10 text-sm text-[#9090B8] leading-relaxed">
        ...
        <strong className="text-white"> State of California, United States</strong>, and comply with applicable federal and California consumer protection laws.
      </div>
      ...
      <Section title="2. Eligibility">
        <ul>
          <li>You must be at least <strong className="text-white">13 years of age</strong> to use the Service. We do not knowingly collect information from children under 13 (COPPA).</li>
      ...
      <Section title="3. Service Description & Plans">
        <ul>
          <li><strong className="text-white">Free Plan:</strong> On-device AI detection, risk alerts, basic statistics, app safety scan.</li>
          <li><strong className="text-white">Paid Plan (Monthly Subscription):</strong> Gemini AI deep analysis, detailed threat reports, URL safety scanning.</li>
        </ul>
      ...
      <Section title="4. Subscriptions, Billing & Refunds">
        <ul>
          <li>Paid subscriptions are processed through the <strong className="text-white">Google Play Store</strong>. By subscribing, you authorize recurring charges at the applicable rate.</li>
          ...
          <li><strong className="text-white">California Residents:</strong> Under the California Automatic Renewal Law (Business &amp; Professions Code § 17600 et seq.), we disclose that your subscription will automatically renew. You may cancel at any time as described above.</li>
        </ul>
      </Section>
      ...
      <Section title="7. Disclaimer of Warranties">
        <div className="bg-white/4 border border-white/8 rounded-xl p-4 text-xs uppercase tracking-wide text-[#6060A0]">
      ...
      <Section title="9. Dispute Resolution & Arbitration">
        <ul>
          <li><strong className="text-white">Informal Resolution First:</strong> Before filing any claim, you agree to contact us at support@vibeacorp.com and give us 30 days to resolve the dispute informally.</li>
          <li><strong className="text-white">Binding Arbitration:</strong> If informal resolution fails, disputes shall be resolved by binding individual arbitration administered by the American Arbitration Association (AAA) under its Consumer Arbitration Rules, not in court.</li>
          <li><strong className="text-white">Class Action Waiver:</strong> You waive the right to participate in class action lawsuits or class-wide arbitration.</li>
          <li><strong className="text-white">Small Claims Exception:</strong> Either party may bring claims in small claims court for qualifying disputes.</li>
          <li><strong className="text-white">Governing Law:</strong> These Terms are governed by the laws of the State of California, without regard to conflict of law principles.</li>
          <li><strong className="text-white">California Residents:</strong> You may report complaints to the California Department of Consumer Affairs at 1-800-952-5210 or www.dca.ca.gov.</li>
        </ul>
      </Section>

      <Section title="10. Changes to These Terms">
        <p>We may update these Terms from time to time. We will notify you of material changes via in-app notice or email at least <strong className="text-white">30 days</strong> before the changes take effect. Continued use of the Service after the effective date constitutes acceptance of the updated Terms.</p>
      </Section>
  ...
  return (
    <>
      <div className="bg-[rgba(91,110,245,0.06)] border border-[rgba(91,110,245,0.2)] rounded-xl p-5 mb-10 text-sm text-[#9090B8] leading-relaxed">
        ...
        安裝或使用本服務，即表示您同意本條款。本條款依據<strong className="text-white">中華民國（台灣）消費者保護法</strong>、
        <strong className="text-white">電子商務消費者保護綱領</strong>及相關法律規定訂定。
      </div>
      ...
      <Section title="第二條（定義）">
        <ul>
          <li><strong className="text-white">「本服務」</strong>係指本公司提供之 ScamLens AI 行動應用程式及相關功能之全部。</li>
          <li><strong className="text-white">「使用者」</strong>係指同意本條款並使用本服務之人。</li>
          <li><strong className="text-white">「付費服務」</strong>係指透過訂閱付款所提供之 Gemini AI 深度分析等進階功能。</li>
          <li><strong className="text-white">「裝置端 AI」</strong>係指直接在使用者裝置上執行之人工智慧分析功能。</li>
        </ul>
      </Section>
      ...
      <Section title="第三條（條款之效力及變更）">
        <ul>
          ...
          <li>本公司得因合理事由修改本條款，修改後之條款將於生效日<strong className="text-white">七日前</strong>公告通知。對使用者不利之變更，將於<strong className="text-white">三十日前</strong>通知。</li>
      ...
      <Section title="第四條（服務內容）">
        <ul>
          <li><strong className="text-white">免費服務：</strong>裝置端 AI 簡訊詐騙偵測、風險通知、基本統計、應用程式安全掃描</li>
          <li><strong className="text-white">付費服務（月訂閱）：</strong>Gemini AI 深度分析、詳細偵測報告、網址安全性檢查</li>
        </ul>
      ...
      <Section title="第五條（付費服務及退款）">
        <ul>
          ...
          <li>依據消費者保護法第19條，數位內容服務因已提供之特性，<strong className="text-white">七日鑑賞期猶豫權</strong>可能受限，請於訂閱前詳閱。</li>
      ...
      <Section title="第九條（服務中斷及終止）">
        <ul>
          <li>本公司於無法繼續提供服務時，將於<strong className="text-white">三十日前</strong>公告後終止服務。</li>
      ...
      <Section title="第十條（準據法及爭議解決）">
        <ul>
          <li>本條款依<strong className="text-white">中華民國（台灣）法律</strong>解釋及適用。</li>
          <li>爭議發生時，雙方應先行協商解決。</li>
          <li>協商不成時，以<strong className="text-white">台灣台北地方法院</strong>為第一審管轄法院。</li>
          <li>消費者得向<strong className="text-white">行政院消費者保護委員會</strong>或各縣市消費者服務中心申訴。</li>
        </ul>
      </Section>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-10">
      ...
      <div className="space-y-3 text-[#9090B8] text-sm leading-relaxed [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-2">
        {children}
      </div>
    </div>
  )
...
function ContactBox({ items }: { items: [string, string][] }) {
  return (
    <div className="bg-white/4 border border-white/8 rounded-xl p-5 space-y-1.5 text-sm text-[#9090B8]">
      {items.map(([label, value]) => (
        <p key={label}><strong className="text-white">{label}:</strong> {value}</p>
      ))}
    </div>
  )
}
