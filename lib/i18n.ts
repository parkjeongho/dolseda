...
const ko = {
  ...
  hero: {
    badge: "ScamLens AI 한국 출시",
    line1: "AI 기술 위에",
    line2: "사람의 경험을 다시 설계합니다.",
    desc: "스미싱·피싱 문자를 AI가 실시간으로 탐지합니다. 내 가족의 폰도 함께 보호하세요.",
...
const en: Translations = {
  ...
  hero: {
    ...
    line1: "Building Human Experiences",
    line2: "on Top of AI Technology",
    desc: "AI detects smishing and phishing messages in real time. Protect your family's phones too.",
...
const zhTW: Translations = {
  ...
  hero: {
    ...
    line1: "以 AI 技術為基礎",
    line2: "重新打造人們的使用體驗",
    desc: "AI 即時偵測詐騙簡訊與釣魚訊息。同時守護您全家人的手機。",
